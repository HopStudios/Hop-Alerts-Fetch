...
Hop Alerts Fetch is a custom add-on that fetches alert reports from different sources and create entries from them.

If you want to use it, please buy it ([contact us](https://www.hopstudios.com/contact_us)).
